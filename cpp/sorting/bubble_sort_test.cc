...
SORTING_TEST_BINARY_RANDOM(bubble_sort);
SORTING_TEST_BINARY_SORTED_LAST10PRANDOM(bubble_sort);
...
SORTING_TEST_BINARY_RANDOM(bubble_sort2);
SORTING_TEST_BINARY_SORTED_LAST10PRANDOM(bubble_sort2);
