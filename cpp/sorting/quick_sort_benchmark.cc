...
static void BM_QuickSortAsc(benchmark::State& state) {
...
static void BM_QuickSortDesc(benchmark::State& state) {
    const int n = state.range(0);
...
// $ bazel run //sorting:quick_sort_benchmark --compilation_mode=opt
BENCHMARK_MAIN();
