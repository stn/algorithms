...
SORTING_TEST_BINARY_RANDOM(insertion_sort);
SORTING_TEST_BINARY_SORTED_LAST10PRANDOM(insertion_sort);
...
SORTING_TEST_BINARY_RANDOM(insertion_sort2);
SORTING_TEST_BINARY_SORTED_LAST10PRANDOM(insertion_sort2);
...
SORTING_TEST_BINARY_RANDOM(insertion_sort3);
SORTING_TEST_BINARY_SORTED_LAST10PRANDOM(insertion_sort3);
